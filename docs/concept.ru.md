...
Каждая отдельная планета - это игровой сервер. Каркас планеты одинаков у всех копий, а "флора и фауна" - не совсем. 

Каждый отдельный сервер (или каждую игровую сессию) различают случайно сгенерированные уровни и (частично) предметы.
...
### Нанометровые скопления систем микросервисов на основе очень маленьких портативных вычислительных машин

Во вселенной игры были разработаны нанометровые летающие вычислительные машины, которые могут перемещаться в крайне малом пространстве.
